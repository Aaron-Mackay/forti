...
Load [shared prep](../frontend-design/reference/shared-prep.md) first. If no design context exists yet, run `teach-impeccable` before proceeding. Additionally gather: what the interface is trying to accomplish.
