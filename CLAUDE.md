...
The endpoint index is auto-generated at `docs/agent/api-index.md` via `npm run api:index`. Update route code/contracts and regenerate the index instead of manually editing route prose in this file.
