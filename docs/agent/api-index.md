...
- /api/auth/mobile/refresh | methods=POST | auth=none | contracts=@forti/shared
- /api/auth/mobile/sign-out | methods=POST | auth=none | contracts=@forti/shared
- /api/auth/mobile/token-exchange | methods=POST | auth=none | contracts=@forti/shared
...
- /api/coach/activate | methods=POST | auth=session | contracts=@lib/contracts/coach
- /api/coach/check-in-template | methods=GET,PUT,DELETE | auth=session | contracts=@lib/contracts/checkIn
...
- /api/coach/learning-plans | methods=GET,POST | auth=session | contracts=@lib/contracts/learningPlans
- /api/coach/learning-plans/[planId] | methods=GET,PATCH,DELETE | auth=session | contracts=@lib/contracts/learningPlans
- /api/coach/learning-plans/[planId]/assignments | methods=POST | auth=session | contracts=@lib/contracts/learningPlans
- /api/coach/learning-plans/[planId]/assignments/[assignmentId] | methods=DELETE | auth=session | contracts=-
- /api/coach/learning-plans/[planId]/steps | methods=POST | auth=session | contracts=@lib/contracts/learningPlans
- /api/coach/learning-plans/[planId]/steps/[stepId] | methods=PATCH,DELETE | auth=session | contracts=@lib/contracts/learningPlans
- /api/coach/learning-plans/[planId]/steps/reorder | methods=PUT | auth=session | contracts=@lib/contracts/learningPlans
- /api/coach/logo | methods=GET,POST,DELETE | auth=session | contracts=-
- /api/coach/request | methods=POST,DELETE | auth=session | contracts=@lib/contracts/coach
- /api/coach/request/[requestId] | methods=PATCH | auth=session | contracts=@lib/contracts/coach
- /api/coach/unlink | methods=DELETE | auth=session | contracts=-
- /api/cron/check-in-reminders | methods=GET | auth=none | contracts=-
- /api/cron/learning-plan-steps | methods=GET | auth=none | contracts=@lib/contracts/learningPlans
- /api/event | methods=POST | auth=none | contracts=@lib/contracts/events
...
- /api/learning-plan-assignments | methods=GET | auth=session | contracts=@lib/contracts/learningPlans
- /api/learning-plan-assignments/[assignmentId]/steps/[stepId]/complete | methods=PATCH | auth=session | contracts=@lib/contracts/learningPlans
...
- /api/metric | methods=POST | auth=none | contracts=@lib/contracts/metrics
...
- /api/plan/[planId] | methods=DELETE | auth=session | contracts=-
...
- /api/sets | methods=POST | auth=session | contracts=@lib/contracts/sets
- /api/sets/[setId] | methods=PATCH,DELETE | auth=session | contracts=@lib/contracts/sets
