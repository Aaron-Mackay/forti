...
- /api/auth/mobile/refresh | methods=POST | auth=none | contracts=@lib/contracts/mobileAuth
- /api/auth/mobile/sign-out | methods=POST | auth=none | contracts=@lib/contracts/mobileAuth
- /api/auth/mobile/token-exchange | methods=POST | auth=none | contracts=@lib/contracts/mobileAuth
...
- /api/user/settings | methods=GET,PATCH | auth=session | contracts=@lib/contracts/userSettings
